...
<body style="background:url('../Images/clouddata2.png') no-repeat center ;;">
  <div class="" style="height:80px;margin-bottom: 30px;padding:0.01em 16px;color:#fff!important;background-color:#000!important">
    <a href="../student.php" style="color: white;">Go Back<i class="fa fa-arrow-circle-left" style="font-size:45px;color:red"></i></a><center><h1 style="size: 36px;">STUDENT ACADEMIC PROJECT MANAGEMENT APPLICATION</h1></center>
  </div>
  <div id="container" style="margin-left: 150px;">
   <h1>Store your Project documents here</h1>
   <?php
   echo $message;
   ?>
